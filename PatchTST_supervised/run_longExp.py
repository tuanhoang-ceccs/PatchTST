...
if __name__ == '__main__':
    ...
    parser.add_argument('--do_rolling_predict', action='store_true',
                        help='whether to do rolling prediction')
    parser.add_argument('--end_date', type=str, default=None,
                        help='end date for rolling prediction (yyyy-mm-dd)')
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            if args.do_rolling_predict:
                print('>>>>>>>rolling predicting : {}<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<'.format(
                    setting))
